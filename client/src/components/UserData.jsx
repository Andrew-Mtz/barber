          ...
          {!editMode ? (
            <Box className={'container-booking-text'}>
              <Box className={'left-booking-text'}>
                <Typography className={'continue-booking-left'}>
                  Nombre:
                </Typography>
                <Typography className={'continue-booking-left'}>
                  Correo:
              ...
              <Box className={'right-booking-text'}>
                <Typography className={'continue-booking-right'}>
        ...
        <Box className={'card-booking'}>
          <Box className={'container-booking'}>
            <Typography
              ...
              textAlign={'center'}
            >
              Reserva guardada para completar
            </Typography>
            <Box className={'container-booking-text'}>
              <Box className={'left-booking-text'}>
                <Typography className={'continue-booking-left'}>
              ...
              <Box className={'right-booking-text'}>
                ...
                <Typography className={'continue-booking-right'}>
                  {dateRef?.current?.split('-')[2]}/
                  {dateRef?.current?.split('-')[1]}/
                  {dateRef?.current?.split('-')[0]}
                </Typography>
                <Typography className={'continue-booking-right'}>
                  {booking?.hour}
                </Typography>
            ...
            <Box className={'continue-booking-btns'}>
              <Button
                variant="contained"
                onClick={() =>
                  navigate('/booking', { state: { previousPath: '/account' } })
                }
              >
