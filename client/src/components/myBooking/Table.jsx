...
const BookingTable = ({ booking, infoMessage, myReservation, loading }) => {
  ...
  const canceleBooking = async id => {
    try {
      ...
      await fetch(`${baseUrl}/booking/${id}`, {
        method: 'delete',
        headers: {
              ...
              booking.map(book => (
                ...
                >
                  ...
                  <TableCell align="left">
                    {book.barber_name} {book.barber_lastname}
                  </TableCell>
                  ...
                  <TableCell align="center">
                    {book.status === 'scheduled' ? (
                      ...
                      <>
                        <Button
                          variant="contained"
                          onClick={() => handleOpen(book.review_id)}
                        >
                          Dejar reseña
                        </Button>
                        <ModalReview
                  ...
                  <DialogConfirm
                    ...
                    message={`Estas seguro que quieres cancelar la reserva para el dia ${book.booking_date} a las ${book.booking_hour}?`}
                  ></DialogConfirm>
                </TableRow>
              ))
            ) : (
