export const text = {
  ...
  ourServices: {
    ...
    book: {
      btnText: 'Agendar',
      paragraph:
        'En nuestra barbería, los cortes de pelo son una verdadera expresión de arte. Nuestros talentosos barberos dominan una amplia variedad de estilos, desde los clásicos atemporales hasta las tendencias más vanguardistas. Cada corte es realizado con precisión y dedicación para resaltar tus rasgos faciales y realzar tu estilo único. Además, te ofrecemos asesoramiento personalizado para encontrar el corte perfecto que se adapte a tu personalidad, tipo de cabello y preferencias. Déjanos cuidar de tu cabello y experimenta la confianza que proviene de lucir un corte impecable.',
    },
    comments: {
      btnText: 'Reseñas',
      paragraph:
